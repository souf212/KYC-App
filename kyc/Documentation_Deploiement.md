...
2. **Installer l'outil de Build (EAS CLI)**  
...
4. **Configurer le projet pour Android**  
...
5. **Lancer la création de l'APK (Le Build Cloud)**  
...
6. **Installer sur votre Téléphone Android**
